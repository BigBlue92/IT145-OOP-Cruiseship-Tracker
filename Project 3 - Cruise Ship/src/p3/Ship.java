...
public class Ship {
	...
	// Constructor - full
	Ship(String tName, int tBalcony, int tOceanView, int tSuite, int tInterior, boolean tInService) {
		shipName = tName;
	...
	public void printShipData() {
		...
		System.out.println(shipName + spaces + roomBalcony + "\t" + roomOceanView + "\t" + roomSuite + "\t" + roomInterior
				+ "\t\t" + inService);
	}
